...
- **FIX-2**: `install-windows.ps1` — IP homelab hardcoded `192.168.1.100` nel default di `$ApiUrl`; sostituito con placeholder `YOUR-SERVER-IP` coerente con `install-linux.sh`
