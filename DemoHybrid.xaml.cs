...
public partial class DemoHybrid : Window
{
    public DemoHybrid()
    {
        ...
        GridResults.ItemsSource = new[]
        {
            ...
            new HybridRow(false, "PC-UFFICIO-01", "In attesa",     "0%",   "—",            "corp.example.com", "Deploy Base Win11"),
            new HybridRow(false, "PC-UFFICIO-02", "In attesa",     "0%",   "—",            "corp.example.com", "Deploy Base Win11"),
