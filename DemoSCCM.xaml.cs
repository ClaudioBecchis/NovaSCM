...
public partial class DemoSCCM : Window
{
    public DemoSCCM()
    {
        ...
        GridResults.ItemsSource = new[]
        {
            ...
            new SccmRow(false, "PC-UFFICIO-01", "In attesa",     "0%",   "—",            "corp.example.com","Deploy Base Win11"),
            new SccmRow(false, "PC-UFFICIO-02", "In attesa",     "0%",   "—",            "corp.example.com","Deploy Base Win11"),
