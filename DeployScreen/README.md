  ...
  <component name="Microsoft-Windows-Setup" ...>
    <RunSynchronous>
      <RunSynchronousCommand wcm:action="add">
        <Order>1</Order>
        <Path>X:\Deploy\NovaSCMDeployScreen.exe hostname=%COMPUTERNAME% domain=polariscore.local wf="Deploy Base Win 11" server=http://192.168.1.100:9091 key=APIKEY pw_id=14</Path>
...
| `server`   | `http://192.168.1.100:9091` | URL base del server NovaSCM       |
