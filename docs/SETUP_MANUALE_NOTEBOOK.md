...
[INF] Polling — PC=NOTEBOOK-CLAUDIO API=http://192.168.1.100:9091
...
| `server=` | URL server NovaSCM | http://192.168.1.100:9091 |
| `key=` | API Key | (vuoto) |
...
2026-03-10 10:23:01 [INF] Polling — PC=NOTEBOOK-CLAUDIO API=http://192.168.1.100:9091
...
# Testa la chiave
Invoke-RestMethod -Uri "http://192.168.1.100:9091/api/version" `
...
# Modalità reale
& "C:\ProgramData\NovaSCM\NovaSCMDeployScreen.exe" hostname=$env:COMPUTERNAME domain=polariscore.local wf="Deploy Base" server=http://192.168.1.100:9091 key=API_KEY pw_id=1

# ── SERVER (da qualsiasi PC sulla rete) ────────────────────────
$s = "http://192.168.1.100:9091"
$h = @{ "X-Api-Key" = "API_KEY" }
...
# ── DIAGNOSTICA RETE ───────────────────────────────────────────
Test-NetConnection 192.168.1.100 -Port 9091
