...
| Versione | Data | Note |
|---|---|---|
| **v2.2.1** | 2026-03-12 | 🐛 fix #9: DPAPI fallback plain-base64 se Kaspersky blocca keystore |
| v1.8.1 | 2026-03-09 | 🔒 Round 7: X-Api-Key UI, cascade delete workflow, PRAGMA foreign_keys, settings validation |
